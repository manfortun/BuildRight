...
const AdminRenderer = ({ showEditBtns = true, ...props }) => {
    ...
    if (props.children?.length > 0) {
        finalizedProps.children = props.children.map(c => <AdminRenderer showEditBtns={false} {...c} />);
    }

    return <AdminRender showEditBtns={showEditBtns} {...finalizedProps } />
}

export default AdminRenderer;


const AdminRender = ({ showEditBtns, ...props }) => {
